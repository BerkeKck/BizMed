...
uses
  ...
  cxTimeEdit, cxCheckGroup, cxImageComboBox, cxCalendar;
...
procedure TfrmMCDiabetesNurseForm.OracleDataSet1DetAfterPost(DataSet: TDataSet);
begin
  inherited;
 //
end;
...
begin
  ...
  try
    ...
    OracleDataSet1Det.FieldByName('DNF_ID').AsInteger := OracleDataSet1.FieldByName('ID').AsInteger;
